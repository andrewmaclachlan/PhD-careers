...
```{r echo=FALSE, out.width = "200pt", fig.align='center'}
knitr::include_graphics('https://media.giphy.com/media/3o6Ygfw40tlnPhX87m/giphy.gif') 
```
...
# This often doesn't fit easily into job roles as they are usually focus on one or two of these
--
...
# Within your PhD you will have shown all these skills but they aren't always directly obvious like perhaps in an industry workplace envrionment 
...
---
# Example 2 - grade 7 role statement
...
### But...I never got a offer from a job interview 
